...
DarkLabel is used to create and label images made with 640 x 640 resolution as frame-by-frame images.
...
```
<br><br><br><br>
&bull; train, val 폴더에 DarkLabel에서 만든 이미지와 라벨을 넣는다.<br><br><br><br>
...
&bull; 비디오를 불러와 저장된 훈련 모델로 학습하여 exp폴더에 저장한다.<br>
```python
